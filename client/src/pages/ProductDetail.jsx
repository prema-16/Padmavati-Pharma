    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden flex items-center justify-center p-4">
          {product.image
            ? <img src={imgUrl(product.image)} alt={product.name} className="max-w-full max-h-96 w-auto h-auto object-contain" />
            : <div className="w-full h-96 flex items-center justify-center bg-primary/5 text-8xl opacity-20">💊</div>}
        </div>
